...
export default function Nomad() {
  ...
  const exSpent = useMemo(() => ex.filter(e => e.walletId !== "__tracked__"), [ex]);
  const finScore = useMemo(() => computeFinanceScore({ expenses: exSpent, incomes: inc, recurring: rec }), [exSpent, inc, rec]);
  ...
  const exAll = useMemo(() => [...exSpent, ...settlementsAsExpenses], [exSpent, settlementsAsExpenses]);
